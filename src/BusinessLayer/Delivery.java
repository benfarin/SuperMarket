...
public class Delivery {
    ...
    public Delivery(int id, Date date, int exit, int truckNum, String driverN, int deliveryWeight, List<Location> locations, int truckWeight, Truck truck){
        // counter presents delivery's id
        counter++;
        this.id = counter;
        this.date=date;
        this.exitTime=exit;
    ...
    public Delivery(int id,Date date,int exitTime,int num,String drivName,String makor,String ya3ad,int truckW,int deliveryWeight){
        this.id=id;
